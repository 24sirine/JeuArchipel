...
/**
 * Fenêtre à afficher lorqu'un joueur est en puits. Il a alors le choix : payer pour en sortir, ou rester et jouer sa libération aux dés.
 * @see FenetrePrincipale
 */
public class FenetreSortirPuits {
	...
	/**
	 * Unique constructeur de la classe {@link FenetreSortirPuits}, prenant en paramètre la {@link FenetrePrincipale} fp.
	 * @param fp FenetrePrincipale
	 * @see FenetrePrincipale
	 */
	public FenetreSortirPuits(FenetrePrincipale fp) {
